...
class ApplenewsManager {
  ...
  public function getDocumentDataFromEntity(EntityInterface $entity, $template) {
    ...
    // Allows modifying the entity before returning it as JSON.
    $this->moduleHandler->alter('applenews_document', $document, $entity, $template);
